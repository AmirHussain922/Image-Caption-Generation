...
"""
Script to generate sample training artifacts for Image Caption Generator
"""
...
def create_tokenizer_pickle(file_path):
    word_index = {
        '<OOV>': 1,
        '<start>': 2,
        '<end>': 3,
...
def create_features_pickle(file_path, num_samples=10):
    features = {}
...
def create_training_history(file_path):
...
if __name__ == "__main__":
    print("Generating sample training artifacts for Image Caption Generator...")
    ...
    create_tokenizer_pickle('working/tokenizer/tokenizer.pickle')
    print("✓ Created tokenizer.pickle")
    
    create_features_pickle('working/features/features.pickle', num_samples=10)
    print("✓ Created features.pickle (10 demo images)")
    
    create_training_history('working/training_history.json')
    print("✓ Created training_history.json")
    
    # Create dummy weight file placeholders
    for filename in [
        'model-best.h5',
        'model-best.keras', 
        'model-epoch-10.h5', 
    ...
    print("\nAll training artifacts generated successfully! 🎉")
